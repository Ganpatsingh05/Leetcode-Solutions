...
<p style="user-select: auto;">&nbsp;</p>
<strong style="user-select: auto;">Follow-up:&nbsp;</strong>Can you come up with an algorithm that is less than <code style="user-select: auto;">O(n<sup style="user-select: auto;">2</sup>)</code><font face="monospace" style="user-select: auto;">&nbsp;</font>time complexity?</div>